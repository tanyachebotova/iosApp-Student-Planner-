...
// здесь хранятся задачи, расписание, прогресс, XP, уровень и достижения
...
final class StudentPlannerViewModel: ObservableObject {
    ...
    //список занятий для экрана "Расписание"
    @Published var lessons: [Lesson] = [
        Lesson(subject: "Разработка приложений", time: "09:00", room: "Ауд. 304", teacher: "Иванов И.И."),
        Lesson(subject: "Базы данных", time: "11:00", room: "Ауд. 210", teacher: "Петров А.А."),
        Lesson(subject: "Проектирование систем", time: "13:30", room: "Ауд. 118", teacher: "Лебедева Л.С."),
        Lesson(subject: "Английский язык", time: "15:20", room: "Ауд. 412", teacher: "Золчева А.П.")
    ]
